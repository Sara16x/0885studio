# Digital Design Week — assets folder

Drop project artwork into this folder. The page (`digitaldesignweek.html`)
...
`digitaldesignweek.html` (search for `cover.svg`) and on `index.html`.

## Edit the copy
Body text, year, and meta descriptions are placeholders. Open
`digitaldesignweek.html` and update:
